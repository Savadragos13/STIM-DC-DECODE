...
public class Test_camera extends LinearOpMode {
    ...
    class SamplePipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            // --- DETECTARE SFERE FOLOSIND HOUGH CIRCLES ---
            Mat circles = new Mat();
            Imgproc.HoughCircles(
                    ...
                    1.2,
                    50,         // distanță minimă între cercuri
                    100,        // param 1
                    30,         // param 2 (sensitivitate)
                    15,         // raza minimă
                    70          // raza maximă
            );
            ...
            // Dacă nu există cercuri => return imaginea originală
            if (circles.cols() > 0) {
